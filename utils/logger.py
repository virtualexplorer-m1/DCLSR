...
class Logger(object):
    ...
    def _create_logger(self):
        ...
        if self.args.log:
            ...
            folder_name = main_path +   '/tensorboard/'

            file_path = 'dataset_'+str(self.args.dataset) + '_alpha_'+str(self.args.alpha) + '_kappa_'+str(self.args.kappa)+ '_tau_'+str(self.args.tau) + '_eta_'+str(self.args.eta) +  '_num_'+str(self.args.num) + '_num_heads_'+str(self.args.num_heads) + '_cluster_num_'+str(self.args.cluster_num) +  '_rate_'+str(self.args.rate)+ '_num_cluster_'+str(self.args.num_cluster) +   '_ccal_'+str(self.args.ccal) + '__'+ now_str   + '.txt'
        else:
