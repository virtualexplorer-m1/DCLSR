...
class Bert4Rec(BaseSeqModel):
    ...
    def forward(self, 
        ...
        log_feats ,_ = self.log2feats(seq, positions) # (bs, max_len, hidden_size)
    ...
    def predict(self, 
        ...
        log_feats,_ = self.log2feats(log_seqs[:, 1:].long(), positions[:, 1:].long()) # user_ids hasn't been used yet
